...
parser.add_argument('--test_dir', default='/shared/djjindal/CEE-data/test_set/', help='Test Data Dir Path')
parser.add_argument('--test_file', default='full_data.json', help='Test File Name')
